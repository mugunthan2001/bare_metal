...
const vectFunc vector[48] __attribute__((section(".vector_A"))) = 
{
...
__attribute__((section(".app_A"))) void resetHandler()
{
    ...
    main(); // Call C Runtime Startup, it will jump to main function
...
__attribute__((section(".app_A"))) void defaultHandler()
{
